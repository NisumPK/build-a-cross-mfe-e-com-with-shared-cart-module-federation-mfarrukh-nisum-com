...
function listenCartItemAdded(handler) {
...
function CartItemRow({ item, onIncrement, onDecrement, onRemove }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("td", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => onDecrement(item.id), "aria-label": `Decrease ${item.name}`, children: "−" }),
      " ",
      item.quantity,
      " ",
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => onIncrement(item.id), "aria-label": `Increase ${item.name}`, children: "+" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("td", { children: [
      "$",
      (item.price * item.quantity).toFixed(2)
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("td", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => onRemove(item.id), children: "Remove" }) })
  ] });
}
...
function CartPage({ coupon }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    ...
    eventBanner && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { style: { background: "#e6ffed", padding: "0.5rem" }, children: [
      'Custom event received: "',
      eventBanner.name,
      '" was added to the cart elsewhere.'
    ] }),
    coupon && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { style: { fontSize: "0.85em", color: "#555" }, children: [
      "Coupon applied (query param ",
      /* @__PURE__ */ jsxRuntimeExports.jsx("code", { children: "?coupon=" }),
      ", display only): ",
      coupon
    ] }),
    items.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Your cart is empty." }) : /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { children: [
    ...
    items.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => dispatch(clearCart()), children: "Clear Cart" })
  ] });
}

export { cartReducer as c, CartPage as default, jsxRuntimeExports as j };
