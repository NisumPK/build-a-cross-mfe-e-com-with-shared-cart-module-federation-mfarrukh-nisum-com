const currentImports = {};
      ...
      let moduleMap = {
"./LoginPage":()=>{
      dynamicLoadingCss([], false, './LoginPage');
      return __federation_import('./__federation_expose_LoginPage-DC8tNoer.js').then(module =>Object.keys(module).every(item => exportSet.has(item)) ? () => module.default : () => module)},};
      const seen = {};
        ...
        cssFilePaths.forEach(cssPath => {
         ...
         if (baseUrl) {
          ...
          if (dontAppendStylesToHead) {
            const key = 'css__auth_mfe__' + exposeItemName;
