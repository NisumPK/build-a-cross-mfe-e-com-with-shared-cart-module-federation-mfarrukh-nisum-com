...
function LoginPage() {
  ...
  if (user) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { padding: "1rem", border: "1px solid #ccc", borderRadius: "4px" }, children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: handleLogout, style: { padding: "0.5rem 1rem", cursor: "pointer" }, children: "Logout" })
    ] });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleLogin, style: { maxWidth: "300px", padding: "1rem", border: "1px solid #ccc", borderRadius: "4px" }, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "submit", style: { padding: "0.5rem 1rem", cursor: "pointer" }, children: "Login" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { style: { fontSize: "0.85em", color: "#666", marginTop: "1rem" }, children: [
      "Demo user: ",
      /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "user@example.com" }),
      " / ",
...
export { authReducer as a, configureStore as c, LoginPage as default, jsxRuntimeExports as j };
