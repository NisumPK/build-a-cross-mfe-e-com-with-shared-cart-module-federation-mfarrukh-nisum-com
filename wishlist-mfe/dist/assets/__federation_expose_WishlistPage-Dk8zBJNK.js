...
function WishlistPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { children: "❤️ My Wishlist" }),
    items.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Your wishlist is empty. Add items from the catalog!" }) : /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: items.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("td", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => handleMoveToCart(item.id), children: "Move to Cart" }),
            " ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => dispatch(removeFromWishlist(item.id)), children: "Remove" })
          ] })
        ] }, item.id)) })
      ] }),
      items.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => dispatch(clearWishlist()), children: "Clear Wishlist" })
    ] })
  ] });
}

export { cartReducer as c, WishlistPage as default, jsxRuntimeExports as j, wishlistReducer as w };
