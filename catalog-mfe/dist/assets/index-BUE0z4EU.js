...
import { j as jsxRuntimeExports, e as cartReducer } from './products-Du5H8IMT.js';
import { r as reactDomExports } from './index-D9Af7wOI.js';
import ProductList from './__federation_expose_ProductList-BdZUrChG.js';
import ProductDetails from './__federation_expose_ProductDetails-Di9xs6zI.js';
...
function ListRoute() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(ProductList, { onSelectProduct: (id) => navigate(`/product/${id}?ref=list`) });
}
function DetailsRoute() {
  const { id } = useParams();
  const [searchParams] = useSearchParams();
  return /* @__PURE__ */ jsxRuntimeExports.jsx(ProductDetails, { id: id ?? "", refParam: searchParams.get("ref") });
}
function StandaloneApp() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { padding: "1rem" }, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { style: { background: "#fffae6", padding: "0.5rem" }, children: [
      "Standalone mode — this app normally runs embedded inside the Host via Module Federation. This local store/router only exists so it also works when opened directly. ",
      /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/", children: "Back to list" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Routes, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/", element: /* @__PURE__ */ jsxRuntimeExports.jsx(ListRoute, {}) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/product/:id", element: /* @__PURE__ */ jsxRuntimeExports.jsx(DetailsRoute, {}) })
    ] })
  ] });
}
